...
public class Simulation {
    ...
    public void exportResultsToCSV(String brokerName, List<Cloudlet> cloudletFinishedList, long executionTime) {
        List<String[]> data = new ArrayList<>();

        // Agregar cabeceras
        data.add(new String[]{"Broker", "Cloudlet ID", "Execution Time", "Start Time", "Finish Time"});
        ...
        // Exportar a CSV
        CSVWriter.writeCSV(brokerName + "_results.csv", data);
    }    
}